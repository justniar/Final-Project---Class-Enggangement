        ...
        <>
            <div className="flex flex-col justify-center items-center w-full h-full p-5 sm:p-10">
                <div className="flex flex-col items-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg shadow-lg h-full justify-center mb-2.5 min-h-[70vh] p-5 w-full mt-10">
                    ...
                    <div>
                        <b>Note</b>: Please follow below rules for data set in order to image recognition work
                        <ol>
                            <li>Image should be of single person only.</li>
                            <li>Name of the file/image is considered to recognize the person from query image.</li>
                            <li>For example, image is uploaded with file name neeraj.jpg, neeraj (1).jpg, vageele.jpg, etc. the label will show neeraj if face is matched from data ser in query image.</li>
                            <li>All data will be lost on page refresh.</li>
                        </ol>
                        <b>Privacy Notice:</b>
                        <ul>
                            <li>Uploaded Image are not saved or collected any where for any purpose. Above program is just for demonstration purpose only.</li>
                        </ul>
                    </div>
                </div>
            </div>
